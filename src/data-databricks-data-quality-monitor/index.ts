...
// https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/data-sources/data_quality_monitor
...
export class DataDatabricksDataQualityMonitor extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksDataQualityMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/data-sources/data_quality_monitor#import import section} in the documentation of this resource for the id to use
