...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/custom_app_integration
...
export class CustomAppIntegrationTokenAccessPolicyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CustomAppIntegrationTokenAccessPolicy | undefined {
    ...
    if (this._absoluteSessionLifetimeInMinutes !== undefined) {
      hasAnyValues = true;
      internalValueResult.absoluteSessionLifetimeInMinutes = this._absoluteSessionLifetimeInMinutes;
    }
    if (this._accessTokenTtlInMinutes !== undefined) {
      hasAnyValues = true;
      internalValueResult.accessTokenTtlInMinutes = this._accessTokenTtlInMinutes;
    }
    if (this._enableSingleUseRefreshTokens !== undefined) {
      hasAnyValues = true;
      internalValueResult.enableSingleUseRefreshTokens = this._enableSingleUseRefreshTokens;
    }
  ...
  public set internalValue(value: CustomAppIntegrationTokenAccessPolicy | undefined) {
    if (value === undefined) {
      ...
      this._absoluteSessionLifetimeInMinutes = undefined;
      ...
      this._absoluteSessionLifetimeInMinutes = value.absoluteSessionLifetimeInMinutes;
      this._accessTokenTtlInMinutes = value.accessTokenTtlInMinutes;
      this._enableSingleUseRefreshTokens = value.enableSingleUseRefreshTokens;
      this._refreshTokenTtlInMinutes = value.refreshTokenTtlInMinutes;
    }
  }

  // absolute_session_lifetime_in_minutes - computed: true, optional: true, required: false
  private _absoluteSessionLifetimeInMinutes?: number; 
  public get absoluteSessionLifetimeInMinutes() {
    return this.getNumberAttribute('absolute_session_lifetime_in_minutes');
  }
  public set absoluteSessionLifetimeInMinutes(value: number) {
    this._absoluteSessionLifetimeInMinutes = value;
  }
  public resetAbsoluteSessionLifetimeInMinutes() {
    this._absoluteSessionLifetimeInMinutes = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get absoluteSessionLifetimeInMinutesInput() {
...
export class CustomAppIntegration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomAppIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/custom_app_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/custom_app_integration databricks_custom_app_integration} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: CustomAppIntegrationConfig = {}) {
    ...
    this._userAuthorizedScopes = config.userAuthorizedScopes;
  ...
  // user_authorized_scopes - computed: false, optional: true, required: false
  private _userAuthorizedScopes?: string[]; 
  public get userAuthorizedScopes() {
    return this.getListAttribute('user_authorized_scopes');
  }
  public set userAuthorizedScopes(value: string[]) {
    this._userAuthorizedScopes = value;
  }
  public resetUserAuthorizedScopes() {
    this._userAuthorizedScopes = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get userAuthorizedScopesInput() {
    return this._userAuthorizedScopes;
  }
