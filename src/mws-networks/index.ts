...
// https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/resources/mws_networks
...
export class MwsNetworks extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MwsNetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/resources/mws_networks#import import section} in the documentation of this resource for the id to use
