...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/mws_networks
...
export class MwsNetworksGcpNetworkInfoOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // pod_ip_range_name - computed: false, optional: true, required: false
  ...
  // service_ip_range_name - computed: false, optional: true, required: false
  ...
  public resetServiceIpRangeName() {
    this._serviceIpRangeName = undefined;
  }
  // Temporarily expose input value. Use with caution.
...
export class MwsNetworks extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MwsNetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/mws_networks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/mws_networks databricks_mws_networks} Resource
  *
  * @param scope The scope in which to define this construct
