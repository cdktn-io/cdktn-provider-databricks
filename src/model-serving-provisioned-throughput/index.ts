...
// https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/resources/model_serving_provisioned_throughput
...
export class ModelServingProvisionedThroughput extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ModelServingProvisionedThroughput that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/resources/model_serving_provisioned_throughput#import import section} in the documentation of this resource for the id to use
