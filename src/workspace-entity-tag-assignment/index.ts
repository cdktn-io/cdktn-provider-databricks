...
// https://registry.terraform.io/providers/databricks/databricks/1.132.0/docs/resources/workspace_entity_tag_assignment
...
export class WorkspaceEntityTagAssignment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceEntityTagAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.132.0/docs/resources/workspace_entity_tag_assignment#import import section} in the documentation of this resource for the id to use
