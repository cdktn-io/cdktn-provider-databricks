...
// https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/data-sources/account_iam_direct_group_member_v2
...
export interface DataDatabricksAccountIamDirectGroupMemberV2Config extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataDatabricksAccountIamDirectGroupMemberV2 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksAccountIamDirectGroupMemberV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/data-sources/account_iam_direct_group_member_v2#import import section} in the documentation of this resource for the id to use
