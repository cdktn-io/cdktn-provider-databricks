...
// https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/resources/mws_workspaces
...
export class MwsWorkspaces extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MwsWorkspaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/resources/mws_workspaces#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      expected_workspace_status: cdktf.stringToTerraform(this._expectedWorkspaceStatus),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      compute_mode: {
        value: cdktf.stringToHclTerraform(this._computeMode),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      expected_workspace_status: {
        value: cdktf.stringToHclTerraform(this._expectedWorkspaceStatus),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
