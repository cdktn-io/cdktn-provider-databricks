...
// https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/environments_default_workspace_base_environment
...
export class EnvironmentsDefaultWorkspaceBaseEnvironment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentsDefaultWorkspaceBaseEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/environments_default_workspace_base_environment#import import section} in the documentation of this resource for the id to use
