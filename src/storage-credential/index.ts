...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/storage_credential
...
export interface StorageCredentialConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly providerConfig?: StorageCredentialProviderConfig;
}
...
export class StorageCredentialAwsIamRoleOutputReference extends cdktn.ComplexObject {
...
export class StorageCredentialAzureManagedIdentityOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class StorageCredentialAzureServicePrincipalOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class StorageCredentialCloudflareApiTokenOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class StorageCredentialDatabricksGcpServiceAccountOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class StorageCredentialGcpServiceAccountKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function storageCredentialProviderConfigToTerraform(struct?: StorageCredentialProviderConfigOutputReference | StorageCredentialProviderConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function storageCredentialProviderConfigToHclTerraform(struct?: StorageCredentialProviderConfigOutputReference | StorageCredentialProviderConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class StorageCredentialProviderConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): StorageCredentialProviderConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: StorageCredentialProviderConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class StorageCredential extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/storage_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/storage_credential databricks_storage_credential} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _providerConfig = new StorageCredentialProviderConfigOutputReference(this, "provider_config");
  public get providerConfig() {
    return this._providerConfig;
  }
  public putProviderConfig(value: StorageCredentialProviderConfig) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      provider_config: storageCredentialProviderConfigToTerraform(this._providerConfig.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      provider_config: {
        value: storageCredentialProviderConfigToHclTerraform(this._providerConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "StorageCredentialProviderConfigList",
      },
    };
