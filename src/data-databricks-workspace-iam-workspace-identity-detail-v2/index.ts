...
// https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/data-sources/workspace_iam_workspace_identity_detail_v2
...
export function dataDatabricksWorkspaceIamWorkspaceIdentityDetailV2ProviderConfigToTerraform(struct?: DataDatabricksWorkspaceIamWorkspaceIdentityDetailV2ProviderConfig | cdktn.IResolvable): any {
...
export function dataDatabricksWorkspaceIamWorkspaceIdentityDetailV2ProviderConfigToHclTerraform(struct?: DataDatabricksWorkspaceIamWorkspaceIdentityDetailV2ProviderConfig | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataDatabricksWorkspaceIamWorkspaceIdentityDetailV2ProviderConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDatabricksWorkspaceIamWorkspaceIdentityDetailV2ProviderConfig | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataDatabricksWorkspaceIamWorkspaceIdentityDetailV2ProviderConfig | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataDatabricksWorkspaceIamWorkspaceIdentityDetailV2 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksWorkspaceIamWorkspaceIdentityDetailV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/data-sources/workspace_iam_workspace_identity_detail_v2#import import section} in the documentation of this resource for the id to use
