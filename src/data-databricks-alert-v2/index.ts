...
// https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/alert_v2
...
export function dataDatabricksAlertV2ParametersToTerraform(struct?: DataDatabricksAlertV2Parameters): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataDatabricksAlertV2ParametersToHclTerraform(struct?: DataDatabricksAlertV2Parameters): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataDatabricksAlertV2ParametersOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataDatabricksAlertV2Parameters | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._name !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: DataDatabricksAlertV2Parameters | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._name = undefined;
...
export class DataDatabricksAlertV2ParametersList extends cdktn.ComplexList {
  public internalValue? : DataDatabricksAlertV2Parameters[] | cdktn.IResolvable
  ...
  */
  public get(index: number): DataDatabricksAlertV2ParametersOutputReference {
    return new DataDatabricksAlertV2ParametersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataDatabricksAlertV2 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksAlertV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/alert_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _parameters = new DataDatabricksAlertV2ParametersList(this, "parameters", true);
