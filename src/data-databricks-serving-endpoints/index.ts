...
// https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/data-sources/serving_endpoints
...
export function dataDatabricksServingEndpointsEndpointsTelemetryConfigToTerraform(struct?: DataDatabricksServingEndpointsEndpointsTelemetryConfig | cdktn.IResolvable): any {
  ...
  return {
    enabled_telemetry_features: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.enabledTelemetryFeatures),
...
export function dataDatabricksServingEndpointsEndpointsTelemetryConfigToHclTerraform(struct?: DataDatabricksServingEndpointsEndpointsTelemetryConfig | cdktn.IResolvable): any {
  ...
  const attrs = {
    enabled_telemetry_features: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.enabledTelemetryFeatures),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
...
export class DataDatabricksServingEndpointsEndpointsTelemetryConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDatabricksServingEndpointsEndpointsTelemetryConfig | cdktn.IResolvable | undefined {
    ...
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._enabledTelemetryFeatures !== undefined) {
      hasAnyValues = true;
      internalValueResult.enabledTelemetryFeatures = this._enabledTelemetryFeatures;
    }
    if (this._inferenceTableConfig?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.inferenceTableConfig = this._inferenceTableConfig?.internalValue;
  ...
  public set internalValue(value: DataDatabricksServingEndpointsEndpointsTelemetryConfig | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._enabledTelemetryFeatures = undefined;
      this._inferenceTableConfig.internalValue = undefined;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this.resolvableValue = undefined;
      this._enabledTelemetryFeatures = value.enabledTelemetryFeatures;
      this._inferenceTableConfig.internalValue = value.inferenceTableConfig;
  ...
  // enabled_telemetry_features - computed: true, optional: true, required: false
  private _enabledTelemetryFeatures?: string[]; 
  public get enabledTelemetryFeatures() {
    return this.getListAttribute('enabled_telemetry_features');
  }
  public set enabledTelemetryFeatures(value: string[]) {
    this._enabledTelemetryFeatures = value;
  }
  public resetEnabledTelemetryFeatures() {
    this._enabledTelemetryFeatures = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enabledTelemetryFeaturesInput() {
    return this._enabledTelemetryFeatures;
  }
...
export class DataDatabricksServingEndpoints extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksServingEndpoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/data-sources/serving_endpoints#import import section} in the documentation of this resource for the id to use
