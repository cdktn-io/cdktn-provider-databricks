...
// https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/data-sources/cluster
...
export class DataDatabricksCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/data-sources/cluster#import import section} in the documentation of this resource for the id to use
