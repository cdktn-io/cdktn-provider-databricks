...
// https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/external_location
...
export class DataDatabricksExternalLocation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksExternalLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/external_location#import import section} in the documentation of this resource for the id to use
