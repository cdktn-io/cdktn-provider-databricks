...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/sql_warehouses
...
export class DataDatabricksSqlWarehousesProviderConfigOutputReference extends cdktn.ComplexObject {
...
*/
export class DataDatabricksSqlWarehouses extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksSqlWarehouses that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/sql_warehouses#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "databricks_sql_warehouses", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/sql_warehouses databricks_sql_warehouses} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      warehouse_name_contains: cdktn.stringToTerraform(this._warehouseNameContains),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      warehouse_name_contains: {
        value: cdktn.stringToHclTerraform(this._warehouseNameContains),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
