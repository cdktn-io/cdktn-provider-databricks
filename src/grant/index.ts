...
// https://registry.terraform.io/providers/databricks/databricks/1.114.2/docs/resources/grant
...
export class Grant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Grant that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.2/docs/resources/grant#import import section} in the documentation of this resource for the id to use
