...
// https://registry.terraform.io/providers/databricks/databricks/1.119.0/docs/resources/compliance_security_profile_workspace_setting
...
export class ComplianceSecurityProfileWorkspaceSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComplianceSecurityProfileWorkspaceSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.119.0/docs/resources/compliance_security_profile_workspace_setting#import import section} in the documentation of this resource for the id to use
