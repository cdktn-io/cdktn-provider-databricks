...
// https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/postgres_synced_table
...
export interface PostgresSyncedTableSpecExtraColumns {
  /**
...
export function postgresSyncedTableSpecExtraColumnsToTerraform(struct?: PostgresSyncedTableSpecExtraColumns | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function postgresSyncedTableSpecExtraColumnsToHclTerraform(struct?: PostgresSyncedTableSpecExtraColumns | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class PostgresSyncedTableSpecExtraColumnsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresSyncedTableSpecExtraColumns | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresSyncedTableSpecExtraColumns | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PostgresSyncedTableSpecExtraColumnsList extends cdktn.ComplexList {
  public internalValue? : PostgresSyncedTableSpecExtraColumns[] | cdktn.IResolvable
  ...
  */
  public get(index: number): PostgresSyncedTableSpecExtraColumnsOutputReference {
    return new PostgresSyncedTableSpecExtraColumnsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function postgresSyncedTableSpecNewPipelineSpecToTerraform(struct?: PostgresSyncedTableSpecNewPipelineSpec | cdktn.IResolvable): any {
  ...
  return {
    ...
    pipeline_channel: cdktn.stringToTerraform(struct!.pipelineChannel),
...
export function postgresSyncedTableSpecNewPipelineSpecToHclTerraform(struct?: PostgresSyncedTableSpecNewPipelineSpec | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    pipeline_channel: {
      value: cdktn.stringToHclTerraform(struct!.pipelineChannel),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class PostgresSyncedTableSpecNewPipelineSpecOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PostgresSyncedTableSpecNewPipelineSpec | cdktn.IResolvable | undefined {
    ...
    if (this._pipelineChannel !== undefined) {
      hasAnyValues = true;
      internalValueResult.pipelineChannel = this._pipelineChannel;
    }
  ...
  public set internalValue(value: PostgresSyncedTableSpecNewPipelineSpec | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._pipelineChannel = value.pipelineChannel;
  ...
  // pipeline_channel - computed: true, optional: true, required: false
...
export interface PostgresSyncedTableSpec {
  ...
  */
  readonly extraColumns?: PostgresSyncedTableSpecExtraColumns[] | cdktn.IResolvable;
  /**
...
export function postgresSyncedTableSpecToTerraform(struct?: PostgresSyncedTableSpec | cdktn.IResolvable): any {
  ...
  return {
    ...
    extra_columns: cdktn.listMapper(postgresSyncedTableSpecExtraColumnsToTerraform, false)(struct!.extraColumns),
...
export function postgresSyncedTableSpecToHclTerraform(struct?: PostgresSyncedTableSpec | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    extra_columns: {
      value: cdktn.listMapperHcl(postgresSyncedTableSpecExtraColumnsToHclTerraform, false)(struct!.extraColumns),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresSyncedTableSpecExtraColumnsList",
    },
    new_pipeline_spec: {
...
export class PostgresSyncedTableSpecOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _extraColumns = new PostgresSyncedTableSpecExtraColumnsList(this, "extra_columns", false);
  public get extraColumns() {
    return this._extraColumns;
  }
  public putExtraColumns(value: PostgresSyncedTableSpecExtraColumns[] | cdktn.IResolvable) {
...
export class PostgresSyncedTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresSyncedTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/postgres_synced_table#import import section} in the documentation of this resource for the id to use
