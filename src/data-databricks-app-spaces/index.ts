...
// https://registry.terraform.io/providers/databricks/databricks/1.134.0/docs/data-sources/app_spaces
...
export class DataDatabricksAppSpacesSpacesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // assume_group_id - computed: true, optional: false, required: false
  public get assumeGroupId() {
    return this.getStringAttribute('assume_group_id');
  }
...
export class DataDatabricksAppSpaces extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksAppSpaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.134.0/docs/data-sources/app_spaces#import import section} in the documentation of this resource for the id to use
