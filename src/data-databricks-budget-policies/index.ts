...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies
...
export interface DataDatabricksBudgetPoliciesConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#filter_by DataDatabricksBudgetPolicies#filter_by}
  */
  readonly filterBy?: DataDatabricksBudgetPoliciesFilterBy;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#page_size DataDatabricksBudgetPolicies#page_size}
  */
  readonly pageSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#sort_spec DataDatabricksBudgetPolicies#sort_spec}
  */
  readonly sortSpec?: DataDatabricksBudgetPoliciesSortSpec;
}
export interface DataDatabricksBudgetPoliciesFilterBy {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#creator_user_id DataDatabricksBudgetPolicies#creator_user_id}
  */
  readonly creatorUserId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#creator_user_name DataDatabricksBudgetPolicies#creator_user_name}
  */
  readonly creatorUserName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#policy_name DataDatabricksBudgetPolicies#policy_name}
  */
  readonly policyName?: string;
}

export function dataDatabricksBudgetPoliciesFilterByToTerraform(struct?: DataDatabricksBudgetPoliciesFilterBy | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    creator_user_id: cdktn.numberToTerraform(struct!.creatorUserId),
...
export function dataDatabricksBudgetPoliciesFilterByToHclTerraform(struct?: DataDatabricksBudgetPoliciesFilterBy | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    creator_user_id: {
      value: cdktn.numberToHclTerraform(struct!.creatorUserId),
      isBlock: false,
      type: "simple",
...
export class DataDatabricksBudgetPoliciesFilterByOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDatabricksBudgetPoliciesFilterBy | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataDatabricksBudgetPoliciesFilterBy | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export interface DataDatabricksBudgetPoliciesPoliciesCustomTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#key DataDatabricksBudgetPolicies#key}
  */
  readonly key: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#value DataDatabricksBudgetPolicies#value}
  */
...
export class DataDatabricksBudgetPoliciesPoliciesCustomTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataDatabricksBudgetPoliciesPoliciesCustomTagsList extends cdktn.ComplexList {
  public internalValue? : DataDatabricksBudgetPoliciesPoliciesCustomTags[] | cdktn.IResolvable
...
export interface DataDatabricksBudgetPoliciesPolicies {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#policy_id DataDatabricksBudgetPolicies#policy_id}
  */
...
export class DataDatabricksBudgetPoliciesPoliciesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataDatabricksBudgetPoliciesPoliciesList extends cdktn.ComplexList {
  public internalValue? : DataDatabricksBudgetPoliciesPolicies[] | cdktn.IResolvable
...
export interface DataDatabricksBudgetPoliciesSortSpec {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#descending DataDatabricksBudgetPolicies#descending}
  */
  readonly descending?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#field DataDatabricksBudgetPolicies#field}
  */
  readonly field?: string;
}

export function dataDatabricksBudgetPoliciesSortSpecToTerraform(struct?: DataDatabricksBudgetPoliciesSortSpec | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    descending: cdktn.booleanToTerraform(struct!.descending),
    field: cdktn.stringToTerraform(struct!.field),
  }
}


export function dataDatabricksBudgetPoliciesSortSpecToHclTerraform(struct?: DataDatabricksBudgetPoliciesSortSpec | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    descending: {
      value: cdktn.booleanToHclTerraform(struct!.descending),
      isBlock: false,
      type: "simple",
...
export class DataDatabricksBudgetPoliciesSortSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataDatabricksBudgetPoliciesSortSpec | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataDatabricksBudgetPoliciesSortSpec | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _descending?: boolean | cdktn.IResolvable; 
  public get descending() {
    return this.getBooleanAttribute('descending');
  }
  public set descending(value: boolean | cdktn.IResolvable) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies databricks_budget_policies}
*/
export class DataDatabricksBudgetPolicies extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksBudgetPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "databricks_budget_policies", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policies databricks_budget_policies} Data Source
  *
  * @param scope The scope in which to define this construct
