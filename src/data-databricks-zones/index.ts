...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones
...
export interface DataDatabricksZonesConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones#default_zone DataDatabricksZones#default_zone}
  */
  readonly defaultZone?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones#id DataDatabricksZones#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones#zones DataDatabricksZones#zones}
  */
  readonly zones?: string[];
  /**
  * provider_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones#provider_config DataDatabricksZones#provider_config}
  */
  readonly providerConfig?: DataDatabricksZonesProviderConfig;
}
export interface DataDatabricksZonesProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones#workspace_id DataDatabricksZones#workspace_id}
  */
...
export class DataDatabricksZonesProviderConfigOutputReference extends cdktn.ComplexObject {
...
/**
* Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones databricks_zones}
*/
export class DataDatabricksZones extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "databricks_zones", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/zones databricks_zones} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      default_zone: cdktn.stringToTerraform(this._defaultZone),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      default_zone: {
        value: cdktn.stringToHclTerraform(this._defaultZone),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
