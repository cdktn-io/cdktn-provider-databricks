...
// https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/workspace_entity_tag_assignments
...
export class DataDatabricksWorkspaceEntityTagAssignments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksWorkspaceEntityTagAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/workspace_entity_tag_assignments#import import section} in the documentation of this resource for the id to use
