...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policy
...
export class DataDatabricksBudgetPolicyCustomTagsOutputReference extends cdktn.ComplexObject {
...
export class DataDatabricksBudgetPolicyCustomTagsList extends cdktn.ComplexList {
  public internalValue? : DataDatabricksBudgetPolicyCustomTags[] | cdktn.IResolvable
...
*/
export class DataDatabricksBudgetPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksBudgetPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/budget_policy databricks_budget_policy} Data Source
  *
  * @param scope The scope in which to define this construct
