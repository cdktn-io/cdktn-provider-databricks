...
// https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/data-sources/entity_tag_assignments
...
export class DataDatabricksEntityTagAssignments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksEntityTagAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.98.0/docs/data-sources/entity_tag_assignments#import import section} in the documentation of this resource for the id to use
