...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/directory
...
export class DataDatabricksDirectoryProviderConfigOutputReference extends cdktn.ComplexObject {
...
*/
export class DataDatabricksDirectory extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/directory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/directory databricks_directory} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      workspace_path: cdktn.stringToTerraform(this._workspacePath),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      workspace_path: {
        value: cdktn.stringToHclTerraform(this._workspacePath),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
