...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/connection
...
export class ConnectionProvisioningInfoOutputReference extends cdktn.ComplexObject {
...
export class ConnectionProvisioningInfoList extends cdktn.ComplexList {
...
export class ConnectionProviderConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ConnectionProviderConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: ConnectionProviderConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class Connection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Connection that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/connection#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Connection to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "databricks_connection", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/connection databricks_connection} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putProviderConfig(value: ConnectionProviderConfig) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      provider_config: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "ConnectionProviderConfigList",
      },
    };
