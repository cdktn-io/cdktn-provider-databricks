...
// https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/disaster_recovery_failover_group
...
export class DataDatabricksDisasterRecoveryFailoverGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksDisasterRecoveryFailoverGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/disaster_recovery_failover_group#import import section} in the documentation of this resource for the id to use
