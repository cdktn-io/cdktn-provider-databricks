...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/jobs
...
export class DataDatabricksJobsProviderConfigOutputReference extends cdktn.ComplexObject {
...
*/
export class DataDatabricksJobs extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksJobs that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/jobs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataDatabricksJobs to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "databricks_jobs", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/jobs databricks_jobs} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      job_name_contains: cdktn.stringToTerraform(this._jobNameContains),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      job_name_contains: {
        value: cdktn.stringToHclTerraform(this._jobNameContains),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
