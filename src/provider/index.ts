...
// https://registry.terraform.io/providers/databricks/databricks/1.132.0/docs
...
export class DatabricksProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing DatabricksProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.132.0/docs#import import section} in the documentation of this resource for the id to use
