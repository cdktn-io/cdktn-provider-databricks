...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/postgres_catalog
...
export function postgresCatalogProviderConfigToTerraform(struct?: PostgresCatalogProviderConfig | cdktn.IResolvable): any {
...
export function postgresCatalogProviderConfigToHclTerraform(struct?: PostgresCatalogProviderConfig | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresCatalogProviderConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PostgresCatalogProviderConfig | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: PostgresCatalogProviderConfig | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export function postgresCatalogSpecToTerraform(struct?: PostgresCatalogSpec | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresCatalogSpecToHclTerraform(struct?: PostgresCatalogSpec | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresCatalogSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresCatalogSpec | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresCatalogSpec | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PostgresCatalogStatusOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class PostgresCatalog extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/postgres_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/postgres_catalog databricks_postgres_catalog} Resource
  *
  * @param scope The scope in which to define this construct
