...
// https://registry.terraform.io/providers/databricks/databricks/1.132.0/docs/resources/disable_legacy_features_setting
...
export class DisableLegacyFeaturesSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DisableLegacyFeaturesSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.132.0/docs/resources/disable_legacy_features_setting#import import section} in the documentation of this resource for the id to use
