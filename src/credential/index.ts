...
// https://registry.terraform.io/providers/databricks/databricks/1.131.0/docs/resources/credential
...
export class Credential extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Credential that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.131.0/docs/resources/credential#import import section} in the documentation of this resource for the id to use
