...
// https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/database_instance
...
export class DataDatabricksDatabaseInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksDatabaseInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/data-sources/database_instance#import import section} in the documentation of this resource for the id to use
