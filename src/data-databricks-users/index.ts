...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/users
...
export function dataDatabricksUsersProviderConfigToTerraform(struct?: DataDatabricksUsersProviderConfig | cdktn.IResolvable): any {
...
export function dataDatabricksUsersProviderConfigToHclTerraform(struct?: DataDatabricksUsersProviderConfig | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataDatabricksUsersProviderConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDatabricksUsersProviderConfig | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataDatabricksUsersProviderConfig | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataDatabricksUsers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/users databricks_users} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _providerConfig = new DataDatabricksUsersProviderConfigOutputReference(this, "provider_config");
  public get providerConfig() {
    return this._providerConfig;
  }
  public putProviderConfig(value: DataDatabricksUsersProviderConfig) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      provider_config: dataDatabricksUsersProviderConfigToTerraform(this._providerConfig.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      provider_config: {
        value: dataDatabricksUsersProviderConfigToHclTerraform(this._providerConfig.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataDatabricksUsersProviderConfig",
      },
      users: {
