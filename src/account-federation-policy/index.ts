...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/account_federation_policy
...
export function accountFederationPolicyOidcPolicyToTerraform(struct?: AccountFederationPolicyOidcPolicy | cdktn.IResolvable): any {
...
export function accountFederationPolicyOidcPolicyToHclTerraform(struct?: AccountFederationPolicyOidcPolicy | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AccountFederationPolicyOidcPolicyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AccountFederationPolicyOidcPolicy | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: AccountFederationPolicyOidcPolicy | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class AccountFederationPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountFederationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/account_federation_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/resources/account_federation_policy databricks_account_federation_policy} Resource
  *
  * @param scope The scope in which to define this construct
