...
JobTriggers, 
jobTriggersToTerraform, 
jobTriggersToHclTerraform, 
JobTriggersList, 
...
export interface JobConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly triggers?: JobTriggers[] | cdktn.IResolvable;
  /**
...
export class Job extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Job that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.129.0/docs/resources/job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _triggers = new JobTriggersList(this, "triggers", false);
  public get triggers() {
    return this._triggers;
  }
  public putTriggers(value: JobTriggers[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      triggers: cdktn.listMapper(jobTriggersToTerraform, true)(this._triggers.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      triggers: {
        value: cdktn.listMapperHcl(jobTriggersToHclTerraform, true)(this._triggers.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "JobTriggersList",
      },
