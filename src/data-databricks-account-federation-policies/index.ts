...
// https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/account_federation_policies
...
export interface DataDatabricksAccountFederationPoliciesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataDatabricksAccountFederationPoliciesPoliciesOidcPolicyOutputReference extends cdktn.ComplexObject {
...
export class DataDatabricksAccountFederationPoliciesPoliciesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataDatabricksAccountFederationPoliciesPoliciesList extends cdktn.ComplexList {
  public internalValue? : DataDatabricksAccountFederationPoliciesPolicies[] | cdktn.IResolvable
...
*/
export class DataDatabricksAccountFederationPolicies extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksAccountFederationPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/account_federation_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "databricks_account_federation_policies", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/account_federation_policies databricks_account_federation_policies} Data Source
  *
  * @param scope The scope in which to define this construct
