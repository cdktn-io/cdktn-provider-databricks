...
# CDKTN prebuilt bindings for databricks/databricks provider version 1.114.1

This repo builds and publishes the [Terraform databricks provider](https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform databricks provider](https://registry.terraform.io/providers/databricks/databricks/1.114.1)
