...
# CDKTN prebuilt bindings for databricks/databricks provider version 1.123.0

This repo builds and publishes the [Terraform databricks provider](https://registry.terraform.io/providers/databricks/databricks/1.123.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform databricks provider](https://registry.terraform.io/providers/databricks/databricks/1.123.0)
