...
```go
import "github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18/workspacefile"
...
&workspacefile.WorkspaceFileConfig {
	...
	Md5: *string,
	ObjectId: *f64,
	ProviderConfig: github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18.workspaceFile.WorkspaceFileProviderConfig,
	Source: *string,
}
```
...
| <code><a href="#@cdktn/provider-databricks.workspaceFile.WorkspaceFileConfig.property.objectId">ObjectId</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.122.0/docs/resources/workspace_file#object_id WorkspaceFile#object_id}. |
