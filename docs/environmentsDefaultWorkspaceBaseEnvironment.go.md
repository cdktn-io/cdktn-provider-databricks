...
```go
import "github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v16/environmentsdefaultworkspacebaseenvironment"
...
&environmentsdefaultworkspacebaseenvironment.EnvironmentsDefaultWorkspaceBaseEnvironmentConfig {
	...
	ProviderConfig: github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v16.environmentsDefaultWorkspaceBaseEnvironment.EnvironmentsDefaultWorkspaceBaseEnvironmentProviderConfig,
}
```
