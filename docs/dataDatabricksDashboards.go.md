...
```go
import "github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v16/datadatabricksdashboards"
...
&datadatabricksdashboards.DataDatabricksDashboardsConfig {
	...
	ProviderConfig: github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v16.dataDatabricksDashboards.DataDatabricksDashboardsProviderConfig,
}
```
