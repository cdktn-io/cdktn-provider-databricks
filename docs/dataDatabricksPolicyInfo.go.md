...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/datadatabrickspolicyinfo"
...
| <code><a href="#@cdktf/provider-databricks.dataDatabricksPolicyInfo.DataDatabricksPolicyInfoColumnMask.property.using">Using</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.99.0/docs/data-sources/policy_info#using DataDatabricksPolicyInfo#using}. |
