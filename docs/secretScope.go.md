...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/v15/secretscope"
...
&secretscope.SecretScopeConfig {
	...
	KeyvaultMetadata: github.com/cdktf/cdktf-provider-databricks-go/databricks/v15.secretScope.SecretScopeKeyvaultMetadata,
}
```
