...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/externalmetadata"
...
| <code><a href="#@cdktf/provider-databricks.externalMetadata.ExternalMetadataConfig.property.properties">Properties</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.99.0/docs/resources/external_metadata#properties ExternalMetadata#properties}. |
