...
&datadatabricksregisteredmodelversions.DataDatabricksRegisteredModelVersionsConfig {
	...
	ProviderConfig: github.com/cdktf/cdktf-provider-databricks-go/databricks.dataDatabricksRegisteredModelVersions.DataDatabricksRegisteredModelVersionsProviderConfig,
}
```
