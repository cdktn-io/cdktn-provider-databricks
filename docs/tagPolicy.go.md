...
```go
import "github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18/tagpolicy"
...
&tagpolicy.TagPolicyConfig {
	...
	TagKey: *string,
	Description: *string,
	ProviderConfig: github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18.tagPolicy.TagPolicyProviderConfig,
	Values: interface{},
}
```
...
| <code><a href="#@cdktn/provider-databricks.tagPolicy.TagPolicyConfig.property.values">Values</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/tag_policy#values TagPolicy#values}. |
