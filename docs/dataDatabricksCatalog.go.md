...
&datadatabrickscatalog.DataDatabricksCatalogCatalogInfo {
	...
	ManagedEncryptionSettings: github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v16.dataDatabricksCatalog.DataDatabricksCatalogCatalogInfoManagedEncryptionSettings,
	MetastoreId: *string,
	Name: *string,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-databricks.dataDatabricksCatalog.DataDatabricksCatalogCatalogInfo.property.browseOnly">BrowseOnly</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/catalog#browse_only DataDatabricksCatalog#browse_only}. |
...
| <code><a href="#@cdktn/provider-databricks.dataDatabricksCatalog.DataDatabricksCatalogCatalogInfo.property.createdAt">CreatedAt</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/catalog#created_at DataDatabricksCatalog#created_at}. |
...
| <code><a href="#@cdktn/provider-databricks.dataDatabricksCatalog.DataDatabricksCatalogCatalogInfo.property.options">Options</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/catalog#options DataDatabricksCatalog#options}. |
...
| <code><a href="#@cdktn/provider-databricks.dataDatabricksCatalog.DataDatabricksCatalogCatalogInfo.property.properties">Properties</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/catalog#properties DataDatabricksCatalog#properties}. |
...
| <code><a href="#@cdktn/provider-databricks.dataDatabricksCatalog.DataDatabricksCatalogCatalogInfo.property.updatedAt">UpdatedAt</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.1/docs/data-sources/catalog#updated_at DataDatabricksCatalog#updated_at}. |
...
&datadatabrickscatalog.DataDatabricksCatalogCatalogInfoManagedEncryptionSettings {
	AzureEncryptionSettings: github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v16.dataDatabricksCatalog.DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsAzureEncryptionSettings,
...
datadatabrickscatalog.NewDataDatabricksCatalogCatalogInfoManagedEncryptionSettingsAzureEncryptionSettingsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsAzureEncryptionSettingsOutputReference
```
...
```go
func InternalValue() DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsAzureEncryptionSettings
```
...
datadatabrickscatalog.NewDataDatabricksCatalogCatalogInfoManagedEncryptionSettingsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-databricks.dataDatabricksCatalog.DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.IInterpolatingParent</code> | The parent resource. |
...
```go
func PutAzureEncryptionSettings(value DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsAzureEncryptionSettings)
```
...
```go
func AzureEncryptionSettings() DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsAzureEncryptionSettingsOutputReference
```
...
```go
func AzureEncryptionSettingsInput() DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsAzureEncryptionSettings
```
...
```go
func InternalValue() DataDatabricksCatalogCatalogInfoManagedEncryptionSettings
```
...
```go
func PutManagedEncryptionSettings(value DataDatabricksCatalogCatalogInfoManagedEncryptionSettings)
```
...
```go
func ManagedEncryptionSettings() DataDatabricksCatalogCatalogInfoManagedEncryptionSettingsOutputReference
```
...
```go
func ManagedEncryptionSettingsInput() DataDatabricksCatalogCatalogInfoManagedEncryptionSettings
```
