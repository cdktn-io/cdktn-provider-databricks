...
```go
import "github.com/cdktf/cdktf-provider-databricks-go/databricks/disablelegacyaccesssetting"
...
&disablelegacyaccesssetting.DisableLegacyAccessSettingConfig {
	...
	DisableLegacyAccess: github.com/cdktf/cdktf-provider-databricks-go/databricks.disableLegacyAccessSetting.DisableLegacyAccessSettingDisableLegacyAccess,
	Etag: *string,
	Id: *string,
	SettingName: *string,
}
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-databricks.disableLegacyAccessSetting.DisableLegacyAccessSettingDisableLegacyAccess.property.value">Value</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.99.0/docs/resources/disable_legacy_access_setting#value DisableLegacyAccessSetting#value}. |
